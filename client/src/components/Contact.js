...
const BlockDialog = ({ open, handleClose }) => {
  return (
    ...
    >
      <DialogTitle id="responsive-dialog-title">Block Contact</DialogTitle>
      <DialogContent>
        <DialogContentText>
      ...
      <Stack sx={{ height: "100%" }}>
        ...
        <Stack sx={{ height: "100%", position: "relative", flexGrow: 1, overflowY: "scroll" }} p={3} spacing={3}>
          ...
          <Stack spacing={0.5}>
            ...
            <Typography variant='body2'>Hey there I am using conversa</Typography>
          </Stack>
          <Divider />
          ...
          <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"}>
            ...
            <IconButton onClick={() => {
              dispatch(updateSidebarType("STAREED"))
            }}>
              <CaretRight />
            </IconButton>
          </Stack>
